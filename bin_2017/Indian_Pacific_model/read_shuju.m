clc
clear
dirs=dir('E:/fortran代码/model_Indian_Pacfic/model_Indian_Pacfic/output/*.dat');
...
for t=1:360
    fid=fopen(strcat('E:/fortran代码/model_Indian_Pacfic/model_Indian_Pacfic/output/',char(filenames(t))));
