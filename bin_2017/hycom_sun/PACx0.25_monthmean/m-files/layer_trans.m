...
xlabel('Month');
ylabel('Sv');
title('PACb0.25  Seasonal Transport of KC  ')
set(gca,'fontsize',11)
%save('../Output/18N_Trans_Ctrl.mat','Trans_Ctrl');
save('../Output/18N_Trans_Sen.mat','trans_mean');
