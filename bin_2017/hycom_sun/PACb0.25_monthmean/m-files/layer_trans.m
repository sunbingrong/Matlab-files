...
save('../Output/18N_Trans_180E.mat','trans_mean');
...
m   =  length(lon);
n    =  length(lat);
a = find(lon >=127 & lon<=129.25);
b = find(lat >=7.5 & lat <=8.5);
...
set(gca,'fontsize',11)
save('../Output/8N_Trans_180E.mat','trans_mean');