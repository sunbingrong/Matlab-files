...
clear;clc
HYCOM_global_url = 'http://tds.hycom.org/thredds/dodsC/GLBu0.08/expt_19.1';
depth = ncread(HYCOM_global_url,'depth');
...
%---------------------------------date num-------------------------------%%
cha_day = time/24;
year_month_day_0 = [2000 01 01];
date_num_0 = datenum(year_month_day_0);
Hycom_daynum = cha_day + date_num_0;
Hycom_year_month_day = datestr(Hycom_daynum,'yyyymmdd');
k = 0;
for i = 486:6325    %start from 1997.01.01 - 2012.12.31%
