clear;clc;
latitude  = ncread('../Output/yr0002_0004monthlyMean3D.nc.xyz3','lat');
longitude = ncread('../Output/yr0002_0004monthlyMean3D.nc.xyz3','lon');
depth     = ncread('../Output/yr0002_0004monthlyMean3D.nc.xyz3','dep');
V         = ncread('../Output/yr0002_0004monthlyMean3D.nc.xyz3','Vg');
[nz,nx,ny,nt] = size(V);
...
xlabel('Month');
ylabel('Latitude(¡ãN)');
title('135E   force: Seasonal   BC: Seasonal')
saveas(gcf,'../Output/HYCOM_Lu_bifur3.jpg');