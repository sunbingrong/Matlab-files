clear;clc;
latitude  = ncread('../Output/yr0002_0004monthlyMean3D.nc.xyz1','lat');
longitude = ncread('../Output/yr0002_0004monthlyMean3D.nc.xyz1','lon');
depth     = ncread('../Output/yr0002_0004monthlyMean3D.nc.xyz1','dep');
V         = ncread('../Output/yr0002_0004monthlyMean3D.nc.xyz1','Vg');
[nz,nx,ny,nt] = size(V);
...
xlabel('Month');
ylabel('Latitude(¡ãN)');
saveas(gcf,'../Output/HYCOM_Lu_bifur1.jpg');